...
import EarningsPage from "./pages/TenantAdmin/EarningsPage";
        ...
        <Routes>
          ...
          <Route element={<ProtectedRoute />}>
            <Route element={<AppLayout />}>
              ...
              {/* Tenant Admin */}
              <Route path="/tenant/settings" element={<SchoolSettings />} />
              <Route path="/tenant/earnings" element={<EarningsPage />} />
            </Route>
          </Route>
